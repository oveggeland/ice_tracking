...
public:
    ...
    // Project 3D points in world frame onto the image plane
    Eigen::Matrix2Xf project(const Eigen::Matrix3Xf& points, const Eigen::Matrix4f& cTw) const {
    ...
    // Project 3D points in cam frame onto the image plane
    Eigen::Matrix2Xf projectPoints(const Eigen::Matrix3Xf& points) const {
